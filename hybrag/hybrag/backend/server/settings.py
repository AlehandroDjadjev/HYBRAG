...
SAGEMAKER_TEXT_ENDPOINT_NAME = os.getenv('SAGEMAKER_TEXT_ENDPOINT_NAME', SAGEMAKER_ENDPOINT_NAME)
SAGEMAKER_IMAGE_ENDPOINT_NAME = os.getenv('SAGEMAKER_IMAGE_ENDPOINT_NAME', SAGEMAKER_ENDPOINT_NAME)
